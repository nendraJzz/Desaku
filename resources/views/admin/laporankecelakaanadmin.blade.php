        ...
        <div class="bg-white w-5/6 md:w-1/2 lg:w-1/3 xl:w-1/4 p-4 rounded-lg">
            <div>
                <div class="flex">
                    ...
                    <h1 class="font-semibold text-abu2 ml-2">Laporkan Kecelakaan</h1>
                </div>
            ...
            <form class="w-full mt-2" method="POST" action="{{ route('laporkanadmin') }}">
                ...
                <textarea name="text" class="textarea textarea-bordered w-full bg-transparent" placeholder="Laporan Kecelakaan"></textarea>
