...
<head>
  ...
  <title>Laporan Kecelakaan Admin - Desaku</title>
      ...
      <div class="flex justify-center pt-5">
        <div class="bg-white w-5/6 md:w-1/2 lg:w-1/3 xl:w-1/4 p-16 rounded-lg relative">
            <div class="flex absolute top-0 left-0 p-3">
                <img src="img/icon-kec.png" class="h-6 w-7 pt-0.5" alt="">
                <p class="text-abu2 pl-2"><span class="font-semibold">Laporkan Kecelakaan</span> <br> <span class="text-sm mt-3">Keterangan :</span></p>
            </div>
            <form class="px-5 pt-10 flex justify-center" method="POST" action="{{ route('laporkec.lapor')}}" >
                @csrf
                <input name="text" type="text" placeholder="Laporkan kecelakaan" class="input input-bordered input-xs w-64  absolute bottom-0 max-w-xs mb-3" />
