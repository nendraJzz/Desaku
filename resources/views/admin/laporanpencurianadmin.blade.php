...
<body class="bg-gray-300">
  <nav class="green py-2">
    ...
    <div class="flex green opacity-80 justify-center px-5">
        ...
        <div class="bg-white w-5/6 md:w-1/2 lg:w-1/3 xl:w-1/4 p-4 rounded-lg ">
            ...
            <form class="flex gap-2 w-full mt-16" method="POST" action="{{ route('laporkanadmin')}}" >
                <div>
                    ...
                    <input name="text" type="text" placeholder="Laporkan Pencurian" class="input input-bordered input-xs md:w-72" />
                </div>
                <button type="submit">
      ...
      <footer class="text-gray-500 mt-4 fixed bottom-0 w-full">
