...
<body class="bg-gray-300">
  <nav class="green py-2">
    ...
    <div class="flex green opacity-80 justify-center px-5">
        ...
        <a href="{{ route('pengumumanadmin') }}" class="md:green hover:green md:text-sm text-black text-xs py-2 px-2 mx-4 md:mx-24 inline-block border-b-2 border-white pb-1">PENGUMUMAN </a>
    </div>
    ...
    <div class="flex justify-center pt-5">
        <div class="bg-white w-5/6 md:w-1/2 lg:w-1/3 xl:w-1/4 p-4 rounded-lg ">
            <div>
                <div class="flex">
                    <h1 class="font-semibold text-abu2">Pengumuman</h1>
                </div>
            ...
            <form class="flex gap-2 w-full mt-2" method="POST" action="{{ route('laporkanadmin')}}" >
                <div>
                    ...
                    <input name="text" type="text" placeholder="Berikan pengumuman" class="input input-bordered input-xs md:w-72" />
                </div>
                <button type="submit">
