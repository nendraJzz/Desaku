...
<body>
    <nav class="green py-4">
        ...
        <div class="w-full mt-16 flex items-center justify-center">
                <div class="mx-auto flex justify-center w-[145px] h-[145px] rounded-full border-4 border-grn bg-[url('https://foto.kontan.co.id/StXCKE_cdjxl3ync1Wq9iTMX4zg=/smart/2023/03/09/1036754397p.jpg')] bg-cover bg-center bg-no-repeat">       
