...
<head>
  ...
  <title>Laporan Kebakaran Admin — Desaku</title>
    ...
    <div class="flex green opacity-80 justify-center px-5">
      ...
      <div class="flex justify-center pt-5">
        <div class="bg-white w-5/6 md:w-1/2 lg:w-1/3 xl:w-1/4 p-4 rounded-lg">
            <div>
                <div class="flex">
                    <img src="img/icon-fire.png" class="h-6 w-7 pt-0.5" alt="">
                    <h1 class="font-semibold text-abu2 ml-2">Laporkan Kebakaran</h1>
                </div>
            ...
            <form class="w-full mt-2" method="POST" action="{{ route('laporkanadmin') }}">
                @csrf
                <input type="text" name="title" class="hidden" value="Laporan Kebakaran" />
                <textarea name="text" class="textarea textarea-bordered w-full bg-transparent" placeholder="Laporan Kebakaran"></textarea>
